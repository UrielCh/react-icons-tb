...
/**
 * SquareLetterYFilled icon from Tabler Icons
 * @module
 */
export function TbSquareLetterYFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareLetterYFilled;
