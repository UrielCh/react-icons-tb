...
/**
 * CircleNumber7Filled icon from Tabler Icons
 * @module
 */
export function TbCircleNumber7Filled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbCircleNumber7Filled;
