...
/**
 * SquareRoundedNumber3Filled icon from Tabler Icons
 * @module
 */
export function TbSquareRoundedNumber3Filled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareRoundedNumber3Filled;
