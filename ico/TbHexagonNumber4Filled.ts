...
/**
 * HexagonNumber4Filled icon from Tabler Icons
 * @module
 */
export function TbHexagonNumber4Filled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbHexagonNumber4Filled;
