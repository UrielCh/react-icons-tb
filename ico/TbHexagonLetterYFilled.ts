...
/**
 * HexagonLetterYFilled icon from Tabler Icons
 * @module
 */
export function TbHexagonLetterYFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbHexagonLetterYFilled;
