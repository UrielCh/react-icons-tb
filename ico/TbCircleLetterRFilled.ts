...
/**
 * CircleLetterRFilled icon from Tabler Icons
 * @module
 */
export function TbCircleLetterRFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbCircleLetterRFilled;
