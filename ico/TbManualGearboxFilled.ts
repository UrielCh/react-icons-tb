...
/**
 * ManualGearboxFilled icon from Tabler Icons
 * @module
 */
export function TbManualGearboxFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbManualGearboxFilled;
