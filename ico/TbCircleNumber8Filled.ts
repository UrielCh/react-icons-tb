...
/**
 * CircleNumber8Filled icon from Tabler Icons
 * @module
 */
export function TbCircleNumber8Filled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbCircleNumber8Filled;
