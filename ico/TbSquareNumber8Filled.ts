...
/**
 * SquareNumber8Filled icon from Tabler Icons
 * @module
 */
export function TbSquareNumber8Filled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareNumber8Filled;
