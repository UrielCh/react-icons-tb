...
/**
 * SquareChevronsLeftFilled icon from Tabler Icons
 * @module
 */
export function TbSquareChevronsLeftFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareChevronsLeftFilled;
