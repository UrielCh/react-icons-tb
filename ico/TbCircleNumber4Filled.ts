...
/**
 * CircleNumber4Filled icon from Tabler Icons
 * @module
 */
export function TbCircleNumber4Filled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbCircleNumber4Filled;
