...
/**
 * CircleLetterMFilled icon from Tabler Icons
 * @module
 */
export function TbCircleLetterMFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbCircleLetterMFilled;
