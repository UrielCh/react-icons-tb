...
/**
 * HexagonLetterMFilled icon from Tabler Icons
 * @module
 */
export function TbHexagonLetterMFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbHexagonLetterMFilled;
