...
/**
 * SquareRoundedChevronUpFilled icon from Tabler Icons
 * @module
 */
export function TbSquareRoundedChevronUpFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareRoundedChevronUpFilled;
