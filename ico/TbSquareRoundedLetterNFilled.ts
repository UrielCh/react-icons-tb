...
/**
 * SquareRoundedLetterNFilled icon from Tabler Icons
 * @module
 */
export function TbSquareRoundedLetterNFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareRoundedLetterNFilled;
