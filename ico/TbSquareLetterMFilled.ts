...
/**
 * SquareLetterMFilled icon from Tabler Icons
 * @module
 */
export function TbSquareLetterMFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareLetterMFilled;
