...
/**
 * SquareNumber7Filled icon from Tabler Icons
 * @module
 */
export function TbSquareNumber7Filled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareNumber7Filled;
