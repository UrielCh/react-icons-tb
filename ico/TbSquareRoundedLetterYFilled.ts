...
/**
 * SquareRoundedLetterYFilled icon from Tabler Icons
 * @module
 */
export function TbSquareRoundedLetterYFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareRoundedLetterYFilled;
