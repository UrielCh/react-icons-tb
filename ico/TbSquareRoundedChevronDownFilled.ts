...
/**
 * SquareRoundedChevronDownFilled icon from Tabler Icons
 * @module
 */
export function TbSquareRoundedChevronDownFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareRoundedChevronDownFilled;
