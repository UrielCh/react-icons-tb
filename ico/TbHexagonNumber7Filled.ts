...
/**
 * HexagonNumber7Filled icon from Tabler Icons
 * @module
 */
export function TbHexagonNumber7Filled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbHexagonNumber7Filled;
