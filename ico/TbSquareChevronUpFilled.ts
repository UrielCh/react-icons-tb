...
/**
 * SquareChevronUpFilled icon from Tabler Icons
 * @module
 */
export function TbSquareChevronUpFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareChevronUpFilled;
