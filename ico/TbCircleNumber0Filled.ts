...
/**
 * CircleNumber0Filled icon from Tabler Icons
 * @module
 */
export function TbCircleNumber0Filled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbCircleNumber0Filled;
