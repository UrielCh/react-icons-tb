...
/**
 * SquareChevronDownFilled icon from Tabler Icons
 * @module
 */
export function TbSquareChevronDownFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareChevronDownFilled;
