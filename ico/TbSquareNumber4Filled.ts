...
/**
 * SquareNumber4Filled icon from Tabler Icons
 * @module
 */
export function TbSquareNumber4Filled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareNumber4Filled;
