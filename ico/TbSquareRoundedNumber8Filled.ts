...
/**
 * SquareRoundedNumber8Filled icon from Tabler Icons
 * @module
 */
export function TbSquareRoundedNumber8Filled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareRoundedNumber8Filled;
