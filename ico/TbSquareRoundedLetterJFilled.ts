...
/**
 * SquareRoundedLetterJFilled icon from Tabler Icons
 * @module
 */
export function TbSquareRoundedLetterJFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareRoundedLetterJFilled;
