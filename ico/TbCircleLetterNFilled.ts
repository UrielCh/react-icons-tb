...
/**
 * CircleLetterNFilled icon from Tabler Icons
 * @module
 */
export function TbCircleLetterNFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbCircleLetterNFilled;
