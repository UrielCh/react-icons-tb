...
/**
 * SquareRoundedNumber7Filled icon from Tabler Icons
 * @module
 */
export function TbSquareRoundedNumber7Filled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareRoundedNumber7Filled;
