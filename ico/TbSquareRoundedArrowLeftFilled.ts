...
/**
 * SquareRoundedArrowLeftFilled icon from Tabler Icons
 * @module
 */
export function TbSquareRoundedArrowLeftFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareRoundedArrowLeftFilled;
