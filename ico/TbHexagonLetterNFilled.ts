...
/**
 * HexagonLetterNFilled icon from Tabler Icons
 * @module
 */
export function TbHexagonLetterNFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbHexagonLetterNFilled;
