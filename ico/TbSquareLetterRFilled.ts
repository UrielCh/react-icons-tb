...
/**
 * SquareLetterRFilled icon from Tabler Icons
 * @module
 */
export function TbSquareLetterRFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareLetterRFilled;
