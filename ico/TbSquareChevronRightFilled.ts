...
/**
 * SquareChevronRightFilled icon from Tabler Icons
 * @module
 */
export function TbSquareChevronRightFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareChevronRightFilled;
