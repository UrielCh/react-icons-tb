...
/**
 * SquareChevronLeftFilled icon from Tabler Icons
 * @module
 */
export function TbSquareChevronLeftFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareChevronLeftFilled;
