...
/**
 * HexagonLetterJFilled icon from Tabler Icons
 * @module
 */
export function TbHexagonLetterJFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbHexagonLetterJFilled;
