...
/**
 * BuildingBroadcastTowerFilled icon from Tabler Icons
 * @module
 */
export function TbBuildingBroadcastTowerFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbBuildingBroadcastTowerFilled;
