...
/**
 * CircleNumber3Filled icon from Tabler Icons
 * @module
 */
export function TbCircleNumber3Filled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbCircleNumber3Filled;
