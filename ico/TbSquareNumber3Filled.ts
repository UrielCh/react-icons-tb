...
/**
 * SquareNumber3Filled icon from Tabler Icons
 * @module
 */
export function TbSquareNumber3Filled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareNumber3Filled;
