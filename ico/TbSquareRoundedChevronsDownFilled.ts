...
/**
 * SquareRoundedChevronsDownFilled icon from Tabler Icons
 * @module
 */
export function TbSquareRoundedChevronsDownFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareRoundedChevronsDownFilled;
