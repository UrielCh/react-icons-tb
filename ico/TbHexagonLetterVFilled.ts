...
/**
 * HexagonLetterVFilled icon from Tabler Icons
 * @module
 */
export function TbHexagonLetterVFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbHexagonLetterVFilled;
