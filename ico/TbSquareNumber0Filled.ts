...
/**
 * SquareNumber0Filled icon from Tabler Icons
 * @module
 */
export function TbSquareNumber0Filled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareNumber0Filled;
