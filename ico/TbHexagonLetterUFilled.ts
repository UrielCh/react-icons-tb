...
/**
 * HexagonLetterUFilled icon from Tabler Icons
 * @module
 */
export function TbHexagonLetterUFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbHexagonLetterUFilled;
