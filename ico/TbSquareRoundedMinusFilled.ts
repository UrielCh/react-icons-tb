...
/**
 * SquareRoundedMinusFilled icon from Tabler Icons
 * @module
 */
export function TbSquareRoundedMinusFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareRoundedMinusFilled;
