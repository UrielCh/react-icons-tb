...
/**
 * SquareRoundedLetterUFilled icon from Tabler Icons
 * @module
 */
export function TbSquareRoundedLetterUFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareRoundedLetterUFilled;
