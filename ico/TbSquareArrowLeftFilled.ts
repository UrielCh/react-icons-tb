...
/**
 * SquareArrowLeftFilled icon from Tabler Icons
 * @module
 */
export function TbSquareArrowLeftFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareArrowLeftFilled;
