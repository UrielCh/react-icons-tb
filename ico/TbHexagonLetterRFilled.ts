...
/**
 * HexagonLetterRFilled icon from Tabler Icons
 * @module
 */
export function TbHexagonLetterRFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbHexagonLetterRFilled;
