...
/**
 * SquareRoundedChevronsLeftFilled icon from Tabler Icons
 * @module
 */
export function TbSquareRoundedChevronsLeftFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareRoundedChevronsLeftFilled;
