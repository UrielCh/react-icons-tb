...
/**
 * SquareLetterNFilled icon from Tabler Icons
 * @module
 */
export function TbSquareLetterNFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbSquareLetterNFilled;
