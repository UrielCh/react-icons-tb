...
/**
 * AlbumOff icon from Tabler Icons
 * @module
 */
export function TbAlbumOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
  return GenIcon({tag:"svg",attr:{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},child:[{tag:"path",attr:{d:"M8 4h10a2 2 0 0 1 2 2v10m-.581 3.41c-.362 .364 -.864 .59 -1.419 .59h-12a2 2 0 0 1 -2 -2v-12c0 -.552 .224 -1.052 .585 -1.413"}},{tag:"path",attr:{d:"M12 4v4m1.503 1.497l.497 -.497l2 2v-7"},child:[]},{tag:"path",attr:{d:"M3 3l18 18"},child:[]}]})(props);
}
