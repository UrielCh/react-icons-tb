...
/**
 * CircleLetterYFilled icon from Tabler Icons
 * @module
 */
export function TbCircleLetterYFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbCircleLetterYFilled;
