...
/**
 * CircleLetterXFilled icon from Tabler Icons
 * @module
 */
export function TbCircleLetterXFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default TbCircleLetterXFilled;
